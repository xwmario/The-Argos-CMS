...
@mysqli_free_result($page_name_get);
echo $tpl->render($page_title + $values + $values3 + $values4 + $lang_sys  + $banner88x31 + $banner468x60 + $sliders + $get_menuz + $get_menuz2 + $poll_print + $poll_send_vote); //принтираме всичко в страницата ($values+$values)