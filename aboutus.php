...
$page_title = array('page_title'=>$lang_sys['lang_aboutus']); //title на страницата
...
$aboutus = array('aboutus'=>$aboutus2);
//end aboutus
 
/////////PRINT/////// 
$tpl = $mustache->loadTemplate('aboutus');  //име на темплейт файла
echo $tpl->render($page_title + $values + $values3 + $values4 + $lang_sys + $banner88x31 + $banner468x60 + $sliders + $aboutus ); //принтираме всичко в страницата ($values+$values)