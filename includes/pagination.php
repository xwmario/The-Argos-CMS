...
function pagination($results, $properties = array()) {
	...
	if ($currentPage != 1) {
		$output	.= '<li><a href=\''.$l.'1\'>&#171;</a></li>';
		$output .= '<li><a href=\''.$l.$previousPage.'\' class=\'active\'>‹</a></li>';
	} else {
	...
	for ($p = $loopStart; $p <= $loopRange; $p++) {
		if ($p != $currentPage) {
			$output .= '<li><a href=\''.$l.$p.'\' class=\'active\'>'.$p.'</a></li>';
		} else {
	...
	if ($currentPage != $totalPages) {
		$output .= '<li><a href=\''.$l.$nextPage.'\' class=\'active\'>›</a></li>';
		$output .= '<li><a href=\''.$l.$totalPages.'\' class=\'active\'>&#187;</a></li>';
	} else {
		$output .= '<li><span class=\'inactive\'>›</span></li>';
		$output .= '<li><span class=\'inactive\'>&#187;</span></li>';
	}
